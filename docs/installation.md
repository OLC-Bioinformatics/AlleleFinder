...
`conda create -n allelefinder -c olc-bioinformatics allelefinder=0.1.4=py_0`
...
conda install -c olcbioinformatics allelefinder=0.1.4=py_0
```
...
`pip install allelefinder==0.1.4`
